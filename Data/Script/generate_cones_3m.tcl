proc addLargeOrangeCone {fileID n id s t} {
	...
	puts $fileID "Traffic.$n.Info:"
	puts $fileID "	Large Orange Start Cone"
...
addLargeOrangeCone $fileID 0 $routeID 6 1.5
addLargeOrangeCone $fileID 1 $routeID 6 -1.5
addLargeOrangeCone $fileID 2 $routeID 6.5 1.5
addLargeOrangeCone $fileID 3 $routeID 6.5 -1.5

# Add blue/yellow cones on the left/right side of the track
# UWE modification to allow orange cones to be placed in front of car at start
#addBlueCone $fileID 4 $routeID 0 1.5
#addYellowCone $fileID 5 $routeID 0 -1.5
#addBlueCone $fileID 6 $routeID 3 1.5
#addYellowCone $fileID 7 $routeID 3 -1.5


for {set i 0} {$i < $nCones} {incr i} {
    addBlueCone $fileID [expr "2*$i+4"] $routeID [expr "3*$i+9"] 1.5
	addYellowCone $fileID [expr "2*$i+5"] $routeID [expr "3*$i+9"] -1.5
}
